...
Istniejąca baza: odpal `002`–`006` (są idempotentne) albo zredeployuj Docker/Coolify z `DATABASE_URL` do bazy PostgREST. Kontener zawsze dopina kolumny transferu przez `scripts/ensure-schema.sql`.
